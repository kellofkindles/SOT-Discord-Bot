...
it('should exchange "accessToken" for "userToken"', () => __awaiter(this, void 0, void 0, function* () {
    ...
    const response = yield XboxLiveAuth.exchangeRpsTicketForUserToken('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.WyJaZW55IElDIl0.uhbX3bSPxuuAsz3wxWPIsdzlczxI1LHRGFaX1HoBnzM');
...
it('should try to exchange "RpsTicket", and fail', () => __awaiter(this, void 0, void 0, function* () {
    try {
        yield XboxLiveAuth.exchangeRpsTicketForUserToken('fake');
    }
    catch (err) {
        expect(err.message).toBeTruthy();
    }
